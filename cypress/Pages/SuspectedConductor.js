class SuspectedConductor {

    element = {

        AddConductorButton : () => cy.xpath ('//button[@id="btn_add_suspect"]'),
        ...
        ConductorList :() => cy.xpath ('//button[@id="home-tab"]'),
        ...
        ConductorSuspect :() => cy.xpath('//button[@id="profile-tab"]'),
    ...
    ClickAddConductorButton(){
        this.element.AddConductorButton().click()
    }
...
//                     |_|                                                                                       |_|   |_|                             
    ...
    ClickConductorSuspect(){
        this.element.ConductorSuspect().click()
    }
...
export default SuspectedConductor
